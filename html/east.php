...
<head>
	 <meta charset="UTF8"> 
	 <title>East Coast Rap</title>
	 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
	 <link rel = "stylesheet" type = "text/css" href = "../css/rapCss.css"/>
</head>
<body bgcolor=#ffffff>
	<div>
		<img id="banner" src="../media/controls/banner-east.png" width="100%">
		<center>
			<a href="../index.php">
	...
	$count = 0;
	//Query artists
	$sql = "SELECT * from rapperi_east order by nume asc";
...
<?php
		...
		<h1>Albume</h1>';
		//Query albums
		$sqlAlbum = 'SELECT * from albume_east WHERE artist_id ='. $artist['id'] . ' order by an desc, nume asc';
		...
		while($album = mysqli_fetch_assoc($resultAlbum)){
			...
			//Query songs
			$sqlMelodie = 'SELECT * from melodii_east WHERE album_id ='. $album['id'];
